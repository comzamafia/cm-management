...
const I = {
  ...
  reservation: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="3" y="4" width="18" height="18" rx="2" /><line x1="16" y1="2" x2="16" y2="6" /><line x1="8" y1="2" x2="8" y2="6" /><line x1="3" y1="10" x2="21" y2="10" />
      <path d="M8 15a2 2 0 1 1 4 0" /><circle cx="10" cy="13.5" r="1" />
    </svg>
  ),
  actionPlan: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const NAV_BASE: NavDef[] = [
  ...
  { href: "/logbook",       label: "Logbook",           icon: I.logbook,      minRank: RANK.EMPLOYEE },
  ...
  { href: "/reservations",  label: "Reservation",       icon: I.reservation,   minRank: RANK.SHIFT_LEAD },
